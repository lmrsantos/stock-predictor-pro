    ...
    const cy = cytoscape({
      ...
      style: [
        ...
        },
        {
          ...
          style: {
            shape: "round-rectangle",
            "background-color": "hsl(240 40% 6%)",
            "background-opacity": 1,
            "border-width": 2,
            "border-color": "hsl(263 80% 72%)",
            label: "data(label)",
            color: "hsl(0 0% 100%)",
            "font-size": 16,
            "font-weight": 700,
...

        {
          ...
          style: {
            ...
            "font-weight": 600,
            color: "hsl(0 0% 92%)",
            "text-background-color": "hsl(240 40% 6%)",
        ...
        },
        {
          ...
          style: {
            "border-width": 2.5,
            "border-color": "hsl(263 70% 70%)",
            "line-color": "hsl(263 70% 70%)",
            "target-arrow-color": "hsl(263 70% 70%)",
          },
        },
      ],
      layout: (focus === "top"
